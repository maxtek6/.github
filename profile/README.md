...
+ [WebFrame](https://github.com/maxtek6/WebFrame) - This project is intended to provide a very similar purpose to Electron, allowing developers to create desktop applications using web bases technologies, such as ReactJS. It provides solutions for building and packaging both the C++ and JavaScript code, as well as sane interfaces to handle communication between these two components. Targets can be built and deployed on both desktop and server.
